...
const panchakarmaTherapies = [
  { name: "Vaman", desc: "Induced therapeutic vomiting to expel Kapha toxins", img: "/newimages/vaman-final4.jpg" },
  { name: "Virechana", desc: "Medicated purgation for Pitta cleansing", img: "/newimages/virechan.webp" },
  { name: "Basti", desc: "Medicated enema — the queen of Panchakarma", img: "/newimages/basti11.jpg" },
      ...
      <section className="container-page py-24 grid lg:grid-cols-2 gap-14 items-center">
        ...
        <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="grid grid-cols-2 gap-4">
          <div className="flex flex-col gap-4 mt-8">
            <Card3D><div className="relative group overflow-hidden rounded-2xl"><img src="/newimages/vaman-final4.jpg" alt="Vaman" className="w-full h-40 object-cover transition-transform duration-700 group-hover:scale-110" /><div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center text-white font-medium">Vaman</div></div></Card3D>
            <Card3D><div className="relative group overflow-hidden rounded-2xl"><img src="/newimages/basti11.jpg" alt="Basti" className="w-full h-40 object-cover transition-transform duration-700 group-hover:scale-110" /><div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center text-white font-medium">Basti</div></div></Card3D>
