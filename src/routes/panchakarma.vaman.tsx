  ...
  return (
    <Layout>
      <PageHero 
        ...
        image="/newimages/vaman.png" 
      />
      <section className="container-page py-20 grid lg:grid-cols-2 gap-16 items-start">
        <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
          <p className="text-primary uppercase tracking-[0.2em] text-xs font-semibold">About Vaman</p>
          <h2 className="font-display text-4xl text-foreground mb-6">Kapha Dosha Detoxification</h2>
          <p>
        ...
        <Card3D className="p-8 md:p-12 bg-secondary/30 border-gold/20">
          ...
          <p className="mb-6 text-muted-foreground">Vamana can be used in prophylactic treatment and for the following diseases:</p>
