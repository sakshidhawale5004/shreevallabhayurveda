...
function Testimonials() {
  return (
    <Layout>
      <PageHero eyebrow="Patient Voices" title="What our patients say" subtitle="Every recovery is a story of trust, dedication and authentic Ayurveda." image={bg.url} />
